...
4. The idea is that this store keeps only **legit unit** in the sense defined in the section on alerts. Thus it no forks will be put there unless coming from alerts.
